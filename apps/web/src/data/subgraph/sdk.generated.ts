...
export type DaoFragment = { __typename?: 'DAO', name: string, tokenAddress: any, contractImage: string, description: string, proposalCount: number, totalAuctionSales: any, totalSupply: number, auctionAddress: any };

export type ExploreDaoFragment = { __typename?: 'Auction', endTime: any, dao: { __typename?: 'DAO', id: string, name: string, tokenAddress: any, contractImage: string, description: string, ownerCount: number, proposalCount: number, totalAuctionSales: any, totalSupply: number, symbol: string, projectURI: string }, highestBid?: { __typename?: 'AuctionBid', amount: any, bidder: any } | null, token: { __typename?: 'Token', name: string, image: string, tokenId: any } };
...
export type TokenFragment = { __typename?: 'Token', tokenId: any, tokenContract: any, name: string, image: string, owner: any, mintedAt: any, dao: { __typename?: 'DAO', description: string } };
...
export type DaoListQuery = { __typename?: 'Query', daos: Array<{ __typename?: 'DAO', name: string, tokenAddress: any, contractImage: string, description: string, proposalCount: number, totalAuctionSales: any, totalSupply: number, auctionAddress: any }> };
...
export type ActiveDaosQuery = { __typename?: 'Query', daos: Array<{ __typename?: 'DAO', id: string }> };
...
export type DaoMembersListQuery = { __typename?: 'Query', daotokenOwners: Array<{ __typename?: 'DAOTokenOwner', id: string, owner: any, daoTokenCount: number, daoTokens: Array<{ __typename?: 'Token', mintedAt: any }> }> };
...
export type DaoTokenOwnersQuery = { __typename?: 'Query', daotokenOwners: Array<{ __typename?: 'DAOTokenOwner', dao: { __typename?: 'DAO', name: string, tokenAddress: any, contractImage: string, description: string, proposalCount: number, totalAuctionSales: any, totalSupply: number, auctionAddress: any } }> };
...
export type ExploreDaosPageQuery = { __typename?: 'Query', auctions: Array<{ __typename?: 'Auction', endTime: any, dao: { __typename?: 'DAO', id: string, name: string, tokenAddress: any, contractImage: string, description: string, ownerCount: number, proposalCount: number, totalAuctionSales: any, totalSupply: number, symbol: string, projectURI: string }, highestBid?: { __typename?: 'AuctionBid', amount: any, bidder: any } | null, token: { __typename?: 'Token', name: string, image: string, tokenId: any } }> };
...
export type MyDaosPageQuery = { __typename?: 'Query', auctions: Array<{ __typename?: 'Auction', endTime: any, dao: { __typename?: 'DAO', id: string, name: string, tokenAddress: any, contractImage: string, description: string, ownerCount: number, proposalCount: number, totalAuctionSales: any, totalSupply: number, symbol: string, projectURI: string }, highestBid?: { __typename?: 'AuctionBid', amount: any, bidder: any } | null, token: { __typename?: 'Token', name: string, image: string, tokenId: any } }> };
...
export type TokenQuery = { __typename?: 'Query', token?: { __typename?: 'Token', tokenId: any, tokenContract: any, name: string, image: string, owner: any, mintedAt: any, dao: { __typename?: 'DAO', description: string } } | null };
...
export type TokenWinnerQuery = { __typename?: 'Query', auction?: { __typename?: 'Auction', winningBid?: { __typename?: 'AuctionBid', amount: any, bidder: any } | null } | null };
...
export type TokensQuery = { __typename?: 'Query', tokens: Array<{ __typename?: 'Token', tokenId: any, tokenContract: any, name: string, image: string, owner: any, mintedAt: any, dao: { __typename?: 'DAO', description: string } }> };
...
export const DaoListDocument = gql`
    query DaoList($orderBy: DAO_orderBy, $orderDirection: OrderDirection, $where: DAO_filter, $skip: Int, $first: Int) {
  daos(
    where: $where
    orderBy: $orderBy
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    DaoList(variables?: DaoListQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<DaoListQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<DaoListQuery>(DaoListDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'DaoList', 'query');
    },
    ...
    activeDaos(variables: ActiveDaosQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<ActiveDaosQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<ActiveDaosQuery>(ActiveDaosDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'activeDaos', 'query');
    },
    ...
    myDaosPage(variables?: MyDaosPageQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<MyDaosPageQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<MyDaosPageQuery>(MyDaosPageDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'myDaosPage', 'query');
    },
    ...
    tokenWinner(variables: TokenWinnerQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<TokenWinnerQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<TokenWinnerQuery>(TokenWinnerDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'tokenWinner', 'query');
    },
